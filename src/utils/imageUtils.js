...
/**
 * Handles the high-quality canvas-based export of an edited image.
 */
...
/**
 * Normalizes angle to be within [0, 360) range.
 */
export const normalizeAngle = (angle) => ((angle % 360) + 360) % 360;

/**
 * Checks if the image is portrait or landscape based on its rotation.
 */
